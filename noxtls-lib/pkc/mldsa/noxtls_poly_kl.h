...
#define noxtls_mld_poly_decompose MLD_NAMESPACE_KL(poly_decompose)
/*************************************************
 * Name:        noxtls_mld_poly_decompose
 *
 ...
 *                              c1
 *              - noxtls_mld_poly *a0: pointer to input/output polynomial. Output
...
#define noxtls_mld_poly_make_hint MLD_NAMESPACE_KL(poly_make_hint)
/*************************************************
 * Name:        noxtls_mld_poly_make_hint
 *
 * Description: Compute hint polynomial. The coefficients of which indicate
 *              whether the low bits of the corresponding coefficient of
 *              the input polynomial overflow into the high bits.
 *
 * Arguments:   - noxtls_mld_poly *h: pointer to output hint polynomial
 *              - const noxtls_mld_poly *a0: pointer to low part of input polynomial
 *              - const noxtls_mld_poly *a1: pointer to high part of input polynomial
 *
...
__contract__(
  ...
  requires(memory_no_alias(a0, sizeof(noxtls_mld_poly)))
  requires(memory_no_alias(a1, sizeof(noxtls_mld_poly)))
  assigns(memory_slice(h, sizeof(noxtls_mld_poly)))
  ensures(return_value <= MLDSA_N)
  ensures(array_bound(h->coeffs, 0, MLDSA_N, 0, 2))
);

#define noxtls_mld_poly_use_hint MLD_NAMESPACE_KL(poly_use_hint)
/*************************************************
 * Name:        noxtls_mld_poly_use_hint
 *
 * Description: Use hint polynomial to correct the high bits of a polynomial.
 *
 * Arguments:   - noxtls_mld_poly *b: pointer to output polynomial with corrected high
 *bits
 *              - const noxtls_mld_poly *a: pointer to input polynomial
 *              - const noxtls_mld_poly *h: pointer to input hint polynomial
 **************************************************/
MLD_INTERNAL_API
...
#define noxtls_mld_poly_uniform_eta_4x MLD_NAMESPACE_KL(poly_uniform_eta_4x)
/*************************************************
 * Name:        noxtls_mld_poly_uniform_eta
 *
 ...
 *
 * Arguments:   - noxtls_mld_poly *r0: pointer to first output polynomial
 *              - noxtls_mld_poly *r1: pointer to second output polynomial
 *              - noxtls_mld_poly *r2: pointer to third output polynomial
 *              - noxtls_mld_poly *r3: pointer to fourth output polynomial
...
void noxtls_mld_poly_uniform_eta_4x(noxtls_mld_poly *r0, noxtls_mld_poly *r1, noxtls_mld_poly *r2,
                             ...
                             uint8_t nonce3)
__contract__(
  requires(memory_no_alias(r0, sizeof(noxtls_mld_poly)))
  requires(memory_no_alias(r1, sizeof(noxtls_mld_poly)))
  requires(memory_no_alias(r2, sizeof(noxtls_mld_poly)))
  requires(memory_no_alias(r3, sizeof(noxtls_mld_poly)))
  requires(memory_no_alias(seed, MLDSA_CRHBYTES))
  assigns(memory_slice(r0, sizeof(noxtls_mld_poly)))
  assigns(memory_slice(r1, sizeof(noxtls_mld_poly)))
  assigns(memory_slice(r2, sizeof(noxtls_mld_poly)))
  assigns(memory_slice(r3, sizeof(noxtls_mld_poly)))
...
#if defined(MLD_CONFIG_SERIAL_FIPS202_ONLY)
#define noxtls_mld_poly_uniform_eta MLD_NAMESPACE_KL(poly_uniform_eta)
/*************************************************
 * Name:        noxtls_mld_poly_uniform_eta
 *
...
#define noxtls_mld_poly_uniform_gamma1 MLD_NAMESPACE_KL(poly_uniform_gamma1)
/*************************************************
 * Name:        noxtls_mld_poly_uniform_gamma1
 *
 * Description: Sample polynomial with uniformly random coefficients
...
#if !defined(MLD_CONFIG_SERIAL_FIPS202_ONLY)
#define noxtls_mld_poly_uniform_gamma1_4x MLD_NAMESPACE_KL(poly_uniform_gamma1_4x)
/*************************************************
 * Name:        noxtls_mld_poly_uniform_gamma1_4x
 *
 * Description: Sample polynomial with uniformly random coefficients
 *              in [-(MLDSA_GAMMA1 - 1), MLDSA_GAMMA1] by unpacking output
 *              stream of SHAKE256(seed|nonce)
...
#define noxtls_mld_poly_challenge MLD_NAMESPACE_KL(poly_challenge)
/*************************************************
 * Name:        noxtls_mld_poly_challenge
 *
...
#define noxtls_mld_polyeta_pack MLD_NAMESPACE_KL(polyeta_pack)
/*************************************************
 * Name:        noxtls_mld_polyeta_pack
 *
...
#define noxtls_mld_polyeta_unpack MLD_NAMESPACE_KL(polyeta_unpack)
/*************************************************
 * Name:        noxtls_mld_polyeta_unpack
 *
...
#define noxtls_mld_polyz_pack MLD_NAMESPACE_KL(polyz_pack)
/*************************************************
 * Name:        noxtls_mld_polyz_pack
 *
...
#define noxtls_mld_polyz_unpack MLD_NAMESPACE_KL(polyz_unpack)
/*************************************************
 * Name:        noxtls_mld_polyz_unpack
 *
...
#define noxtls_mld_polyw1_pack MLD_NAMESPACE_KL(polyw1_pack)
/*************************************************
 * Name:        noxtls_mld_polyw1_pack
 *
