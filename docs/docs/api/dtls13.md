...
Use [noxtls_dtls13_context_init](#noxtls_dtls13_context_init) to initialize a [tls13_context_t](/docs/api/tls13#tls13_context_t) for datagram transport. Configure MTU, retransmission, ACK limits, replay handling, and anti-amplification settings with the shared [DTLS API](/docs/api/dtls).
...
- [noxtls_tls13_connect](/docs/api/tls13#noxtls_tls13_connect)
- [noxtls_tls13_accept](/docs/api/tls13#noxtls_tls13_accept)
- [noxtls_tls13_send](/docs/api/tls13#noxtls_tls13_send)
- [noxtls_tls13_recv](/docs/api/tls13#noxtls_tls13_recv)
- [noxtls_tls13_close](/docs/api/tls13#noxtls_tls13_close)
...
See the [DTLS 1.3 guide](/docs/dtls13) for the feature overview and [DTLS common API](/docs/api/dtls) for base DTLS configuration.
