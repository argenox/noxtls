...
description: "NoxTLS documentation: Documentation Parity Matrix."
---
...
| --- | --- | --- | --- |
| TLS 1.0/1.1/1.2/1.3 and DTLS | `noxtls-lib/tls/*` | `api/tls*.md`, `api/dtls*.md`, `tls.md`, `dtls13.md` | Good (0.2.25: DTLS 1.3 docs, DTLS API group, and PQC in `tls13_pqc`) |
