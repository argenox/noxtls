 ...
 * 
 * @param[in] data The data to print as hex
 * @param[in] len The length of the data to print as hex
 */
void print_array_hex(const uint8_t * data, uint32_t len)
{
    uint32_t i;
 ...
 * 
 * @param[in] data The data to print as characters
 * @param[in] len The length of the data to print as characters
 */
void print_array_char(const uint8_t * data, uint32_t len)
{
    uint32_t i;
